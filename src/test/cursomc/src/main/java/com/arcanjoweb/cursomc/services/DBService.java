...
import com.arcanjoweb.cursomc.domain.Pagamento;
import com.arcanjoweb.cursomc.domain.PagamentoComBoleto;
import com.arcanjoweb.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Produto p8 = new Produto(null, "Roçadadeira", 800.00);
		...
		Cliente cli1 = new Cliente(null, "Eugenio Arcanjo", "eugenio@arcanjoweb.com.br", "343434334334", TipoCliente.PESSOAFISICA);
